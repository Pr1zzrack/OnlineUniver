...
class ProfessorAdmin(TranslationAdmin):
...
class CourseAdmin(TranslationAdmin):
    list_display = ("name", "code", "description", "department", "professor")
...
@admin.register(RegCourse)
class RegCourseAdmin(TranslationAdmin):
...
@admin.register(HandingHomeWork)
class HandingHomeWorkAdmin(TranslationAdmin):
